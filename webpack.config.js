...
module.exports = (env, argv) => {
    ...
    const config = {
        ...
        module: {
            rules: [
                {
                    test: /\.(tsx|ts|jsx|js)?$/, // duyệt các file .ts || .tsx
        ...
        output: {
            ...
            path: path.resolve(__dirname, 'build'), // Build ra thư mục build
            publicPath: '/',
        },
        devServer: {
            hot: true, // enable Hot Module Replacement, kiểu như reload nhanh
            port: 3005, // Chạy port 3000 khi dev
